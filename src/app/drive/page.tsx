  ...
  return (
    <div className="bg-{colors.white}">
      <div className="flex h-screen">
        <div className="w-64 bg-{colors.white} p-4">
          ...
          <header className="flex items-center justify-between mb-4">
            <div className="flex space-x-4">
              ...
              <div className="relative w-64">
                <Input className="w-full pl-8" placeholder="Search files..." type="search" />
                <SearchIcon className="absolute left-2.5 top-2.5 h-4 w-4 text-{colors.white}" />
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <Link className="h-9 w-9 flex items-center justify-center" href="#">
                <span className="icon-[mdi--github] text-8xl"></span>
              </Link>
            </div>
          </header>
...
function AlbumIcon(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
